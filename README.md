...
npm start
```
5. In a new terminal, build the frontend server:
```
cd frontend
npm run build
```
...
Once you've completed all the steps, you should be able to save new candidates, both via the web and the API, view them in the database, and retrieve them using GET by id. 
